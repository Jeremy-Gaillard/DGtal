...
/**
 * @file LongvolImageWriter.h
 * @author Jérémy Gaillard (\c jeremy.gaillard@insa-lyon.fr )
 * Institut National des Sciences Appliquées - INSA, France
 *
 * @date 2012/07/03
 *
 * Header file for module LongvolImageWriter.cpp
 *
 * This file is part of the DGtal library.
 */

#if defined(LongvolImageWriter_RECURSES)
#error Recursive header files inclusion detected in LongvolWriter.h
#else // defined(LongvolImageWriter_RECURSES)
/** Prevents recursive inclusion of headers. */
#define LongvolImageWriter_RECURSES

#if !defined LongvolImageWriter_h
/** Prevents repeated inclusion of headers. */
#define LongvolImageWriter_h
...
namespace DGtal
{
  ...
  /**
   * Description of template struct 'LongvolImageWriter' <p>
...
#include "DGtal/io/writers/LongvolImageWriter.ih"
...
#undef LongvolImageWriter_RECURSES
